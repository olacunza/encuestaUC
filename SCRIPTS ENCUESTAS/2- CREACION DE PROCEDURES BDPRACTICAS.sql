...
--FALTA HACER UN SELECT A BLOQUE Y PREGUNTAS DESDE EL BACKEND PARA ENVIAR A TABLA NUEVA INFO COMPLETA
...
GO
ALTER PROCEDURE ENCUESTA.ISP_CREAR_PLANTILLA_ENCUESTA
(
@NOMBRE_ENCUESTA VARCHAR(50)
,@DESCRIPCION_ENCUESTA VARCHAR(200)
,@TIPO_ENCUESTA_ID INT
...
BEGIN
	...
	SELECT 1 FROM ENCUESTA.ENCUESTA_ASIGNATURA	--CAMBIAR POR TABLA DE FOTO ENCUESTA
	WHERE ENCUESTA_ID = @ENCUESTA_ID
		AND ACTIVO = 1
